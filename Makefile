...
COMMON_FLAGS:=-Os -gdwarf-5 -ffunction-sections -fdata-sections -flto -ffat-lto-objects -fstack-protector-all
...
LD:=$(CXX)
LD_FLAGS:=$(COMMON_FLAGS) $(WARNINGS) -Wno-undef -Wl,--gc-sections -fno-lto
